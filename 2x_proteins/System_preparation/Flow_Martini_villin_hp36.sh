...
#Starting structure
pdb=two_villin_h36.pdb

dir=two_villin_h36_init
mkdir $dir
...
#Put protein in box
$gmx editconf -f PRO_CG.pdb -o PRO_CG.gro -bt cubic -box 7.31 7.31 7.31 <<EOF
1
EOF

#Solvate using insane.py
$python2 $insane -f PRO_CG.gro -o PRO_SOL_IONS.gro -pbc keep -salt 0.15 -sol W -center -p PRO_topol_SOL_IONS.top
