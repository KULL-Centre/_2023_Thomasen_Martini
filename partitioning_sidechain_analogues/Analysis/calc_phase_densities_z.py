...
residue=str(sys.argv[1])
ffmod=str(sys.argv[2])
output=f'data/CHEX_W_SC_density_z_{residue}_{ffmod}.pkl'
...
#Density for SC
hs, z = center_slab('.',f'{residue}/{ffmod}/prodrun',start=None,end=None,step=1,input_pdb=f'{residue}/{ffmod}/prodrun.gro',
                        selstr_ref='resname CHEX',selstr_out=['resname CHEX', 'resname W', f'resname {residue}S'],fout=None,write_traj=False,
                                subsampled=False)

results={'density':hs, 'z':z}

save_pickle(output, results)
