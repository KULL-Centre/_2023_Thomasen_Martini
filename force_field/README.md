...
In order to rescale the interactions of protein beads only (and not e.g. lipids), we have modified the original Martini 3.0.0 force field files by adding a new set of protein beads with _PRO in the bead name. 
